        ...
        {screen === 'variation' && (
          <SectionCard title="Variation Claim Builder">
            <div className="summary-box">
              ...
              <p>
                {variationDraft
                  ? `${currency(variationDraft.value)} remains unissued and is at risk of becoming unrecoverable. ${variationDraft.reason}`
            ...
            <div className="form-grid">
              <input
                ...
                defaultValue={variationDraft?.title || ''}
              />
              <input
                className="field"
                placeholder="Changed scope"
                defaultValue={variationDraft?.reason || ''}
              />
              <input
                className="field"
                placeholder="Cause of change"
                defaultValue={variationDraft ? 'Commercial risk identified from dashboard insight' : ''}
              />
              <input
                className="field"
                placeholder="Estimated cost impact"
                defaultValue={variationDraft ? currency(variationDraft.value) : ''}
              />
            </div>
            <div className="summary-box">
